# ----------------------------------------------------------------------------------------------
# DemoDDoS 
# Không dùng Tool vào việc tấn công chính phủ !
#
#
# Copyright: NGUYỄN THÀNH VINH :33
# ----------------------------------------------------------------------------------------------
import urllib
...
def show_usage():
    print(colorama.Fore.GREEN+'Free Đừng Đòi Hỏi (by NTV)')
    print(colorama.Fore.GREEN+'Dùng => python3 server <Link web muốn tấn công>')
    print(colorama.Fore.GREEN+'e.g. python3 server.py https://ddoswebgov.nguvcl')
